...
export default function SplashScreen() {
  ...
  return (
    <ScrollView
      className="flex-1 bg-moon-white"
      contentContainerStyle={{ flexGrow: 1 }}
    >
      <View className="flex-1 items-center justify-center px-6 relative">
        {/* Background decorative blobs */}
        <View className="absolute top-[-10%] left-[-10%] w-[70%] h-[40%] rounded-full bg-lavender/10 blur-3xl" />
        <View className="absolute bottom-[-5%] right-[-5%] w-[60%] h-[40%] rounded-full bg-blush/10 blur-3xl" />
        ...
        <View className="text-center space-y-4 z-10">
          ...
          <Text className="text-text-muted text-lg font-normal leading-relaxed max-w-[280px] mx-auto text-center">
            ...
            <Text className="text-lavender font-medium text-center">Tu ciclo, tu control.</Text>
          </Text>
        </View>
      </View>
